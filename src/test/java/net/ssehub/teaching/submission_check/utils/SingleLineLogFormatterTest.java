...
public class SingleLineLogFormatterTest {
    ...
    public void exceptionWithCause() {
        ...
        SvnException exception = new SvnException("got IO error", cause);
        ...
        assertThat(lines.get(1), is(" ".repeat(21 + 59) + "net.ssehub.teaching.submission_check.svn.SvnException: got IO error"));
